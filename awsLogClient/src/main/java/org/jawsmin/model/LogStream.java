 ...
 * 
 * @see <a href=
 *      "http://docs.aws.amazon.com/goto/WebAPI/logs-2014-03-28/LogStream"
...
public class LogStream implements Serializable, Cloneable {
	...
	public LogStream(String logStreamName, Long creationTime,
			Long firstEventTimestamp, Long lastEventTimestamp,
			Long lastIngestionTime, String uploadSequenceToken, String arn,
			Long storedBytes) {
		super();
	 ...
	 * </p>
	 * 
	 * @return The creation time of the stream, expressed as the number of
	 *         milliseconds after Jan 1, 1970 00:00:00 UTC.
	 */
	 ...
	 * </p>
	 * 
	 * @return The time of the first event, expressed as the number of
	 *         milliseconds after Jan 1, 1970 00:00:00 UTC.
	 */
	 ...
	 * </p>
	 * 
	 * @return The time of the most recent log event in the log stream in
	 *         CloudWatch Logs. This number is expressed as the number of
	 *         milliseconds after Jan 1, 1970 00:00:00 UTC. The
	 *         <code>lastEventTime</code> value updates on an eventual
	 ...
	 * </p>
	 * 
	 * @return The ingestion time, expressed as the number of milliseconds after
	...
	public boolean equals(Object obj) {
		...
		if (other.getCreationTime() == null ^ this.getCreationTime() == null)
			return false;
		if (other.getCreationTime() != null && other.getCreationTime()
				.equals(this.getCreationTime()) == false)
			return false;
		if (other.getFirstEventTimestamp() == null
				^ this.getFirstEventTimestamp() == null)
			return false;
		if (other.getFirstEventTimestamp() != null
				&& other.getFirstEventTimestamp()
						.equals(this.getFirstEventTimestamp()) == false)
			return false;
		...
		if (other.getLastEventTimestamp() != null
				&& other.getLastEventTimestamp()
						.equals(this.getLastEventTimestamp()) == false)
			return false;
		if (other.getLastIngestionTime() == null
				^ this.getLastIngestionTime() == null)
			return false;
		if (other.getLastIngestionTime() != null && other.getLastIngestionTime()
				.equals(this.getLastIngestionTime()) == false)
			return false;
		if (other.getUploadSequenceToken() == null
				^ this.getUploadSequenceToken() == null)
			return false;
		if (other.getUploadSequenceToken() != null
				&& other.getUploadSequenceToken()
						.equals(this.getUploadSequenceToken()) == false)
			return false;
		...
		if (other.getStoredBytes() == null ^ this.getStoredBytes() == null)
			return false;
		if (other.getStoredBytes() != null && other.getStoredBytes()
				.equals(this.getStoredBytes()) == false)
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		hashCode = prime * hashCode + ((getCreationTime() == null)
				? 0
				: getCreationTime().hashCode());
		hashCode = prime * hashCode + ((getFirstEventTimestamp() == null)
				? 0
				: getFirstEventTimestamp().hashCode());
		hashCode = prime * hashCode + ((getLastEventTimestamp() == null)
				? 0
				: getLastEventTimestamp().hashCode());
		hashCode = prime * hashCode + ((getLastIngestionTime() == null)
				? 0
				: getLastIngestionTime().hashCode());
		hashCode = prime * hashCode + ((getUploadSequenceToken() == null)
				? 0
				: getUploadSequenceToken().hashCode());
		hashCode = prime * hashCode
				+ ((getArn() == null) ? 0 : getArn().hashCode());
		hashCode = prime * hashCode + ((getStoredBytes() == null)
				? 0
				: getStoredBytes().hashCode());
		return hashCode;
	}
	...
	// com.amazonaws.services.logs.model.transform.LogStreamMarshaller.getInstance().marshall(this,
	// protocolMarshaller);
	// }
}
