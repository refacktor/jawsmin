...
import org.jawsmin.json.JsonArray;
 ...
 */
public class PutLogEventsRequest implements Serializable, Cloneable {
	 ...
	 * </p>
	 */
	private ArrayList<InputLogEvent> logEvents;
	/**
	 * <p>
	 ...
	 * <code>sequenceToken</code>, both calls might be successful or one might
	 * be rejected.
	 * </p>
	 */
	...
	public void setLogEvents(java.util.Collection<InputLogEvent> logEvents) {
		...
		this.logEvents = new ArrayList<InputLogEvent>(logEvents);
	}
	...
	public PutLogEventsRequest withLogEvents(InputLogEvent... logEvents) {
		if (this.logEvents == null) {
			setLogEvents(new ArrayList<InputLogEvent>(logEvents.length));
		}
	 ...
	 *            <code>sequenceToken</code>, both calls might be successful or
	 ...
	 * </p>
	 * 
	 * @return The sequence token obtained from the response of the previous
	 ...
	 *         >DescribeLogStreams</a>. If you call <code>PutLogEvents</code>
	 *         twice within a narrow time period using the same value for
	 *         <code>sequenceToken</code>, both calls might be successful or one
	 *         might be rejected.
	 */
	...
	public String toString() {
		...
		if (logEvents != null) {
			...
			for (InputLogEvent logEvent : logEvents) {
				logs = Json.array()
						.add(Json.object()
								.set("timestamp", logEvent.getTimestamp())
								.set("message", logEvent.getMessage()));
			}
	...
	public boolean equals(Object obj) {
		...
		if (other.getSequenceToken() == null ^ this.getSequenceToken() == null)
			return false;
		if (other.getSequenceToken() != null && other.getSequenceToken()
				.equals(this.getSequenceToken()) == false)
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		hashCode = prime * hashCode + ((getSequenceToken() == null)
				? 0
				: getSequenceToken().hashCode());
		return hashCode;
	}

	@Override
	public PutLogEventsRequest clone() throws CloneNotSupportedException {
