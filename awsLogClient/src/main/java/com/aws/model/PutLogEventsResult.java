 ...
 */
public class PutLogEventsResult extends JsonMapperModel implements Serializable, Cloneable {
	 ...
	 * </p>
	 * 
	 * @param nextSequenceToken The next sequence token.
	 */
	 ...
	 * </p>
	 * 
	 * @param rejectedLogEventsInfo The rejected events.
	 */
	...
	public JsonMapperModel toModel(String json) {
		...
		if (reponseJson.get("nextSequenceToken") != null)
			result.setNextSequenceToken(reponseJson.get("nextSequenceToken").asString());
		if (reponseJson.get("rejectedLogEventsInfo") != null) {
			JsonObject rejectedLogEventsInfoJson = reponseJson.get("rejectedLogEventsInfo").asObject();
			RejectedLogEventsInfo rejected = new RejectedLogEventsInfo();
			if (rejectedLogEventsInfoJson.get("tooNewLogEventStartIndex") != null)
				rejected.setTooNewLogEventStartIndex(rejectedLogEventsInfoJson.get("tooNewLogEventStartIndex").asInt());
			if (rejectedLogEventsInfoJson.get("tooOldLogEventEndIndex") != null)
				rejected.setTooOldLogEventEndIndex(rejectedLogEventsInfoJson.get("tooOldLogEventEndIndex").asInt());
			if (rejectedLogEventsInfoJson.get("expiredLogEventEndIndex") != null)
				rejected.setExpiredLogEventEndIndex(rejectedLogEventsInfoJson.get("expiredLogEventEndIndex").asInt());
