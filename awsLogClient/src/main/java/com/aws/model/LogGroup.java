 ...
 * 
 * @see <a href=
 *      "http://docs.aws.amazon.com/goto/WebAPI/logs-2014-03-28/LogGroup" target
...
public class LogGroup implements Serializable, Cloneable {
	...
	public LogGroup(String logGroupName, Long creationTime,
			Integer retentionInDays, Integer metricFilterCount, String arn,
			Long storedBytes, String kmsKeyId) {
		super();
	 ...
	 * </p>
	 * 
	 * @return The creation time of the log group, expressed as the number of
	 *         milliseconds after Jan 1, 1970 00:00:00 UTC.
	 */
	...
	public String toString() {
		...
		if (getMetricFilterCount() != null)
			sb.append("MetricFilterCount: ").append(getMetricFilterCount())
					.append(",");
		if (getArn() != null)
	...
	public boolean equals(Object obj) {
		...
		if (other.getRetentionInDays() == null
			...
			return false;
		if (other.getRetentionInDays() != null && other.getRetentionInDays()
				.equals(this.getRetentionInDays()) == false)
			return false;
		if (other.getMetricFilterCount() == null
				^ this.getMetricFilterCount() == null)
			return false;
		if (other.getMetricFilterCount() != null && other.getMetricFilterCount()
				.equals(this.getMetricFilterCount()) == false)
			return false;
	...
	public int hashCode() {
		...
		hashCode = prime * hashCode + ((getRetentionInDays() == null)
				? 0
				: getRetentionInDays().hashCode());
		hashCode = prime * hashCode + ((getMetricFilterCount() == null)
				? 0
	...
	// com.amazonaws.services.logs.model.transform.LogGroupMarshaller.getInstance().marshall(this,
	// protocolMarshaller);
	// }
}
